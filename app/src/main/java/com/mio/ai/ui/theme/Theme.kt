...
fun MioTheme(
    ...
    val scheme = remember(mio) {
        darkColorScheme(
            ...
            surfaceContainerLowest = mio.base,
            surfaceContainerLow = mio.surface,
            surfaceContainer = mio.surface,
            surfaceContainerHigh = mio.surfaceHigh,
            surfaceContainerHighest = mio.surfaceHigh,
            error = mio.danger,
